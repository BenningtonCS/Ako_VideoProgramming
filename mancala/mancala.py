...
def run_simulations(choose_pit, num_games, display_boards=False, print_statistics = False):
	outcomes = [0] * 3

	for i in range(0, num_games):
		winner = play_game(choose_pit, should_display=display_boards, start_player=i%2)
		outcomes[winner] += 1
